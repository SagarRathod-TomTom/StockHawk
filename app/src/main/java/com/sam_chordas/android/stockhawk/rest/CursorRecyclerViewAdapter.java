 ...
 *
 * Abstract base class for Recycler view adapter
 *
 */
public abstract class CursorRecyclerViewAdapter<VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> {
    ...
    /**
     * Constructs the adapter instance if cursor contains one or more columns.
     *
    ...
    /**
     * Returns the id of positioned row from cursor
     *
     * @param position The row position in cursor.
     * @return
     */
    @Override
    ...
    /**
     * Binds the cursor rows to recycler view
     *
     * @param viewHolder
     * @param position
     */
    ...
    /**
     * Swaps the cursor to the adapter if cursor is valid and registers
     * the observer to this cursor.
     *
     * @param newCursor cursor for this adapter instance
     * @return
     */
    ...
    /**
     *  Observes the changes to cursor.
     */
